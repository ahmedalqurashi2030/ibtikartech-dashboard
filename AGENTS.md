...
- في مهام UI/UX والواجهة العامة استخدم مهارة المستودع
  `.agents/skills/ui-ux-pro-max/` واقرأ `SKILL.md` كاملًا قبل التعديل.
- توصيات المهارة مساعدة وليست مصدر الحقيقة الوحيد؛ الكود الحالي وهوية ابتكار
  تك ومتطلبات المهمة هي المرجع الأساسي.
- لا تفرض Design System جديدًا أو ترحيلًا تقنيًا لمجرد اقتراح المهارة.
